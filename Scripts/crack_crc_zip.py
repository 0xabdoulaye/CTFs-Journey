...
import subprocess
import zipfile
#cracking many zip crc without their password
...
parser.add_argument('--alphabet', type=lambda s: s.encode(), default=string.printable.encode())
...
# Compiling C++ code in Python script for better speed and interface
code = ''
code += r'''
#include <cstdio>
#include <vector>
